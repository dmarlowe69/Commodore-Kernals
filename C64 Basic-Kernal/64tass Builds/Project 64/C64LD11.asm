...
LAB_A09E
	.text	"EN",'D'+$80	; END		$80		128
	.text	"FO",'R'+$80	; FOR		$81		129
	.text	"NEX",'T'+$80	; NEXT	$82		130
	.text	"DAT",'A'+$80	; DATA	$83		131
	.text	"INPUT",'#'+$80	; INPUT#	$84		132
	.text	"INPU",'T'+$80	; INPUT	$85		133
	.text	"DI",'M'+$80	; DIM		$86		134
	.text	"REA",'D'+$80	; READ	$87		135

	.text	"LE",'T'+$80	; LET		$88		136
	.text	"GOT",'O'+$80	; GOTO	$89		137
	.text	"RU",'N'+$80	; RUN		$8A		138
	.text	"I",'F'+$80		; IF		$8B		139
	.text	"RESTOR",'E'+$80	; RESTORE	$8C		140
	.text	"GOSU",'B'+$80	; GOSUB	$8D		141
	.text	"RETUR",'N'+$80	; RETURN	$8E		142
	.text	"RE",'M'+$80	; REM		$8F		143

	.text	"STO",'P'+$80	; STOP	$90		144
	.text	"O",'N'+$80		; ON		$91		145
	.text	"WAI",'T'+$80	; WAIT	$92		146
	.text	"LOA",'D'+$80	; LOAD	$93		147
	.text	"SAV",'E'+$80	; SAVE	$94		148
	.text	"VERIF",'Y'+$80	; VERIFY	$95		149
	.text	"DE",'F'+$80	; DEF		$96		150
	.text	"POK",'E'+$80	; POKE	$97		151

	.text	"PRINT",'#'+$80	; PRINT#	$98		152
	.text	"PRIN",'T'+$80	; PRINT	$99		153
	.text	"CON",'T'+$80	; CONT	$9A		154
	.text	"LIS",'T'+$80	; LIST	$9B		155
	.text	"CL",'R'+$80	; CLR		$9C		156
	.text	"CM",'D'+$80	; CMD		$9D		157
	.text	"SY",'S'+$80	; SYS		$9E		158
	.text	"OPE",'N'+$80	; OPEN	$9F		159

	.text	"CLOS",'E'+$80	; CLOSE	$A0		160
	.text	"GE",'T'+$80	; GET		$A1		161
	.text	"NE",'W'+$80	; NEW		$A2		162

; next are the secondary command keywords, these can not start a statement

;LAB_A129
	.text	"TAB",'('+$80	; TAB(	$A3		163
	.text	"T",'O'+$80		; TO		$A4		164
	.text	"F",'N'+$80		; FN		$A5		165
	.text	"SPC",'('+$80	; SPC(	$A6		166
	.text	"THE",'N'+$80	; THEN	$A7		167

	.text	"NO",'T'+$80	; NOT		$A8		168
	.text	"STE",'P'+$80	; STEP	$A9		169
...
; next are the operators
	...
	.byte	'/'+$80		; /		$AD		173
	.byte	'^'+$80		; ^		$AE		174
	.text	"AN",'D'+$80	; AND		$AF		175

	.text	"O",'R'+$80		; OR		$B0		176
	.byte	'>'+$80		; >		$B1		177
	.byte	'='+$80		; =		$B2		178
	.byte	'<'+$80		; <		$B3		179
...
; and finally the functions
	...
	.text	"SG",'N'+$80	; SGN		$B4		180
	.text	"IN",'T'+$80	; INT		$B5		181
	.text	"AB",'S'+$80	; ABS		$B6		182
	.text	"US",'R'+$80	; USR		$B7		183

	.text	"FR",'E'+$80	; FRE		$B8		184
	.text	"PO",'S'+$80	; POS		$B9		185
	.text	"SQ",'R'+$80	; SQR		$BA		186
	.text	"RN",'D'+$80	; RND		$BB		187
	.text	"LO",'G'+$80	; LOG		$BC		188
	.text	"EX",'P'+$80	; EXP		$BD		189
	.text	"CO",'S'+$80	; COS		$BE		190
	.text	"SI",'N'+$80	; SIN		$BF		191

	.text	"TA",'N'+$80	; TAN		$C0		192
	.text	"AT",'N'+$80	; ATN		$C1		193
	.text	"PEE",'K'+$80	; PEEK	$C2		194
	.text	"LE",'N'+$80	; LEN		$C3		195
	.text	"STR",'$'+$80	; STR$	$C4		196
	.text	"VA",'L'+$80	; VAL		$C5		197
	.text	"AS",'C'+$80	; ASC		$C6		198
	.text	"CHR",'$'+$80	; CHR$	$C7		199

	.text	"LEFT",'$'+$80	; LEFT$	$C8		200
	.text	"RIGHT",'$'+$80	; RIGHT$	$C9		201
	.text	"MID",'$'+$80	; MID$	$CA		202

; lastly is GO, this is an add on so that GO TO, as well as GOTO, will work

	.text	"G",'O'+$80		; GO		$CB		203
...
LAB_A19E
	.text	"TOO MANY FILE",'S'+$80
LAB_A1AC
	.text	"FILE OPE",'N'+$80
LAB_A1B5
	.text	"FILE NOT OPE",'N'+$80
LAB_A1C2
	.text	"FILE NOT FOUN",'D'+$80
LAB_A1D0
	.text	"DEVICE NOT PRESEN",'T'+$80
LAB_A1E2
	.text	"NOT INPUT FIL",'E'+$80
LAB_A1F0
	.text	"NOT OUTPUT FIL",'E'+$80
LAB_A1FF
	.text	"MISSING FILE NAM",'E'+$80
LAB_A210
	.text	"ILLEGAL DEVICE NUMBE",'R'+$80
LAB_A225
...
LAB_E473
	.byte	$93,$0D
	.text	"    **** COMMODORE 64 BASIC V2 ****",$0D
	.byte	$0D
	.text	" 64K RAM SYSTEM  ",$00
...
LAB_F0BD
	.text	$0D,"I/O ERROR ",'#'+$80
LAB_F0C9
	.text	$0D,"SEARCHING",' '+$80
LAB_F0D4
	.text	"FOR",' '+$80
LAB_F0D8
	.text	$0D,"PRESS PLAY ON TAP",'E'+$80
LAB_F0EB
	.text	"PRESS RECORD & PLAY ON TAP",'E'+$80
LAB_F106
	.text	$0D,"LOADIN",'G'+$80
LAB_F10E
	.text	$0D,"SAVING",' '+$80
LAB_F116
	.text	$0D,"VERIFYIN",'G'+$80
LAB_F120
	.text	$0D,"FOUND",' '+$80
LAB_F127
	.text	$0D,"OK",$0D+$80
