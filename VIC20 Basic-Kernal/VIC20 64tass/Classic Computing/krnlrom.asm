...
USRPOK 	* = * + 1 ;.byte	$00			;00	USR jump (C64: DDR)
USRVEC 	* = * + 2 ;.word	$00			;01	USR vector (C64: processor reg)
ADRAY1 	* = * + 2 ;.word	$00			;03	float-fixed conversion vector
ADRAY2 	* = * + 2 ;.word	$00			;05	fixed-float conversion vector
CHARAC 	* = * + 1 ;.byte	$00			;07	search character
ENDCHR 	* = * + 1 ;.byte	$00			;08	scan-squtes flag (InQuote)
TABCOL 	* = * + 1 ;.byte	$00			;09	TAB column save
VERCK  	* = * + 1 ;.byte	$00			;0A	Load/verify flag (0=load, 1=verify)
COUNT  	* = * + 1 ;.byte	$00			;0B	input buffer pointer/#subscript
DIMFLG 	* = * + 1 ;.byte	$00			;0C	default DIM flag
VALTYP 	* = * + 1 ;.byte	$00			;0D	value type (ff=string, 0=numeric)
INTFLG 	* = * + 1 ;.byte	$00			;0E	integer flag (80=integer, 0=floating point)
DORES  	* = * + 1 ;.byte	$00			;0F	DATA scan, LIST quote, memory flag
SUBFLG 	* = * + 1 ;.byte	$00			;10	subscript, FNx flag
INPFLG 	* = * + 1 ;.byte	$00			;11	input flag (0=INPUT, 40=GET, 98=READ)
TANSGN 	* = * + 1 ;.byte	$00			;12	ATN sign, comparison evaluation flag
IOPMPT 	* = * + 1 ;.byte	$00			;13	current I/O prompt flag
INTRVL 	* = * + 2 ;.word	$00			;14	integer value
TEMPPT 	* = * + 1 ;.byte	$00			;16	POINTER: temporary string stack
LASTPT 	* = * + 2 ;.word	$00			;17	last temp string vector
TEMPST 	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            ...
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00	;19	stack for temporary strings
            * = * + 1 ;.byte	$00	$00			
UTLPTR 	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00		;22	utility pointer area
ADDEND 	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00		;26	product area for multiplication
TXTTAB 	* = * + 2 ;.word	$00			;2B	POINTER: start of BASIC
VARTAB 	* = * + 2 ;.word	$00			;2D	POINTER: start of variables
ARYTAB 	* = * + 2 ;.word	$00			;2F	POINTER: start of arrays
STREND 	* = * + 2 ;.word	$00			;31	POINTER: end of arrays
FRETOP 	* = * + 2 ;.word	$00			;33	POINTER: string storage (moving down)
FRESPC 	* = * + 2 ;.word	$00			;35	utility string pointer
MEMSIZ 	* = * + 2 ;.word	$00			;37	POINTER: memory limit (memory size)
CURLIN 	* = * + 2 ;.word	$00			;39	current BASIC line number
OLDLIN 	* = * + 2 ;.word	$00			;3B	previous BASIC line number
OLDTXT 	* = * + 2 ;.word	$00			;3D	POINTER: BASIC statement for CONT
DATLIN 	* = * + 2 ;.word	$00			;3F	current DATA line number
DATPTR 	* = * + 2 ;.word	$00			;41	current DATA address
INPPTR 	* = * + 2 ;.word	$00			;43	input vector
VARNAM 	* = * + 2 ;.word	$00			;45	current variable name
VARPNT 	* = * + 2 ;.word	$00			;47	current variable address
FORPNT 	* = * + 2 ;.word	$00			;49	FOR/NEXT variable pointer
YSAVE  	* = * + 2 ;.word	$00			;4B	.Y save, op-save, BASIC pointer save
ACCSYM 	* = * + 1 ;.byte	$00	$00			;4D	accumulator comparison symbol
WORK1  	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00		;4E	miscellaneous work area
JMPER  	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00 $00
            * = * + 1 ;.byte	$00 $00		;54	jump vector for functions
;WORKNV 	.byte	$00		;57	miscellaneous work area - numeric
FC3M1  	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00		;57	sometimes called FC #3
FC4M1  	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00		;5C	sometimes called FC #4
FC1EXP 	* = * + 1 ;.byte	$00	$00			;61	FAC1 exponent
FC1M1  	* = * + 1 ;.byte	$00	$00			;62	FAC1 mantissa
FC1M2  	* = * + 1 ;.byte	$00	$00			;63		
FC1M3  	* = * + 1 ;.byte	$00	$00			;64		
FC1M4  	* = * + 1 ;.byte	$00	$00			;65		
FC1SGN 	* = * + 1 ;.byte	$00	$00			;66	FAC1 sign
SEVALP 	* = * + 1 ;.byte	$00	$00			;67	series evaluation constant pointer
FC1OVF 	* = * + 1 ;.byte	$00	$00			;68	FAC1 overflow
FC2EXP 	* = * + 1 ;.byte	$00	$00			;69	FAC2 exponent
FC2M1  	* = * + 1 ;.byte	$00	$00			;6A	FAC2 mantissa
FC2M2  	* = * + 1 ;.byte	$00	$00			;6B
FC2M3  	* = * + 1 ;.byte	$00	$00			;6C	
FC2M4  	* = * + 1 ;.byte	$00	$00			;6D	
FC2SGN 	* = * + 1 ;.byte	$00	$00			;6E	FAC2 sign
ARISGN 	* = * + 1 ;.byte	$00	$00			;6F	FAC1:FAC2 sign comparison
FC1ROU 	* = * + 1 ;.byte	$00	$00			;70	FAC1 rounding
CSBFLN 	* = * + 2 ;.word	$00	$00			;71	cassette buffer length, series pointer
CHRGET 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00		;73	CHGRET subroutine (next character)
CHRGOT 	* = * + 1 ;.byte	$00	$00			;79	CHRGOT entry (current character)
TXTPTR 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00	;7A	Pointer to current byte of BASIC text
FILLEN 	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00		;88		
RNDX   	* = * + 1 ;.byte	$00	$00
            ...
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00		;8B	RND seed value
CSTAT  	* = * + 1 ;.byte	$00	$00			;90	status word ST
STKEY  	* = * + 1 ;.byte	$00	$00			;91	keyswitch PIA: STOP & RVS flags
SVXT   	* = * + 1 ;.byte	$00	$00			;92	tape timing constant
IOFLG2 	* = * + 1 ;.byte	$00	$00			;93	I/O flag #2 (0=load, 1=verify)
C3PO   	* = * + 1 ;.byte	$00	$00			;94	serial deferred character flag
BSOUT  	* = * + 1 ;.byte	$00	$00			;95	serial deferred character (buffered character)
EOTFLG 	* = * + 1 ;.byte	$00	$00			;96	tape EOT received flag
REGSAV 	* = * + 1 ;.byte	$00	$00			;97	register save
COPNFL 	* = * + 1 ;.byte	$00	$00			;98	number of open files (max 10)
INDEV  	* = * + 1 ;.byte	$00	$00			;99	input device (default 0=KEYBOARD)
OUTDEV 	* = * + 1 ;.byte	$00	$00			;9A	output device (default 3=SCREEN)
TPRTY  	* = * + 1 ;.byte	$00	$00			;9B	tape character parity flag
BYTINF 	* = * + 1 ;.byte	$00	$00			;9C	byte received flag
CMDMOD 	* = * + 1 ;.byte	$00	$00			;9D	command mode (80=direct, 0=run)
TPTR1  	* = * + 1 ;.byte	$00	$00			;9E	tape pass 1 error log/character buffer
TPTR2  	* = * + 1 ;.byte	$00	$00			;9F	tape pass 2 error log/corrected
CTIMR0 	* = * + 1 ;.byte	$00	$00			;A0	jiffy clock (HML)
CTIMR1 	* = * + 1 ;.byte	$00	$00			;A1	 
CTIMR2 	* = * + 1 ;.byte	$00	$00			;A2	
SBITCF 	* = * + 1 ;.byte	$00	$00			;A3	serial bit count/EOI flag
CYCLE  	* = * + 1 ;.byte	$00	$00			;A4	cycle count
CNTDN  	* = * + 1 ;.byte	$00	$00			;A5	countdown - tape write/bit count
BUFPNT 	* = * + 1 ;.byte	$00	$00			;A6	POINTER: tape buffer
INBIT  	* = * + 1 ;.byte	$00	$00			;A7	tape write leader count/read pass/inbit
BITCI  	* = * + 1 ;.byte	$00	$00			;A8	tape write new byte/read error/inbit count
RINONE 	* = * + 1 ;.byte	$00	$00			;A9	write start bit/read bit error/stbit
RIDATA 	* = * + 1 ;.byte	$00	$00			;AA	tape scan, count, leader, end - byte assembly
RIPRTY 	* = * + 1 ;.byte	$00	$00			;AB	write lead length/read CRC/parity
SAL    	* = * + 2 ;.word	$00	$00			;AC	POINTER: tape buffer (scrolling)
EAL    	* = * + 2 ;.word	$00	$00			;AE	POINTER: tape end address/end of program
TPCON1 	* = * + 1 ;.byte	$00	$00			;B0	tape timing constant 1
TPCON2 	* = * + 1 ;.byte	$00	$00			;B1	tape timing constant 2
TAPE1  	* = * + 2 ;.word	$00	$00			;B2	POINTER: start of tape buffer
BITTS  	* = * + 1 ;.byte	$00	$00			;B4	tape timer (1=enable); bit count
NXTBIT 	* = * + 1 ;.byte	$00	$00			;B5	tape EOT;RS232 next bit to send
RODATA 	* = * + 1 ;.byte	$00	$00			;B6	read character error/outbyte buffer
FNMLEN 	* = * + 1 ;.byte	$00	$00			;B7	number of characters in filename
LOGFIL 	* = * + 1 ;.byte	$00	$00			;B8	current logical file#
SECADR 	* = * + 1 ;.byte	$00	$00			;B9	current secondary address
CHANNL 	* = * + 1 ;.byte	$00	$00			;BA	current device number
FNPTR  	* = * + 2 ;.word	$00	$00			;BB	POINTER: filename
ROPRTY 	* = * + 1 ;.byte	$00	$00			;BD	write shift word/read input character
FSBLK  	* = * + 1 ;.byte	$00	$00			;BE	tape pass counter
MYCH   	* = * + 1 ;.byte	$00	$00			;BF	serial word buffer
CAS1   	* = * + 1 ;.byte	$00	$00			;C0	tape motor interlock
STAL   	* = * + 2 ;.word	$00	$00			;C1	I/O start address
MEMUSS 	* = * + 2 ;.word	$00	$00			;C3	I/O end address (POINTER: KERNEL setup)
CURKEY 	* = * + 1 ;.byte	$00	$00			;C5	current key pressed
KEYCNT 	* = * + 1 ;.byte	$00	$00			;C6	number of characters in the keyboard buffer
RVS    	* = * + 1 ;.byte	$00	$00			;C7	screen reverse flag
EOLPTR 	* = * + 1 ;.byte	$00	$00			;C8	POINTER: end of line for INPUT
ICRROW 	* = * + 1 ;.byte	$00	$00			;C9	INPUT cursor row
ICRCOL 	* = * + 1 ;.byte	$00	$00			;CA	INPUT cursor column
KEYDN  	* = * + 1 ;.byte	$00	$00			;CB	which key (64=none)
BLNSW  	* = * + 1 ;.byte	$00	$00			;CC	cursor enable (0=flash)
BLNCT  	* = * + 1 ;.byte	$00	$00			;CD	cursor timing countdown
GDBLN  	* = * + 1 ;.byte	$00	$00			;CE	character under cursor
BLNON  	* = * + 1 ;.byte	$00	$00			;CF	cursor in blink phase
INSRC  	* = * + 1 ;.byte	$00	$00			;D0	input from SCREEN or KEYBOARD
LINPTR 	* = * + 2 ;.word	$00	$00			;D1	POINTER: screen line
CSRIDX 	* = * + 1 ;.byte	$00	$00			;D3	position of cursor on screen line
CSRMOD 	* = * + 1 ;.byte	$00	$00			;D4	cursor mode (0=direct, non-zero=programmed)
LINLEN 	* = * + 1 ;.byte	$00	$00			;D5	screen line length ($16=22d)
CURROW 	* = * + 1 ;.byte	$00	$00			;D6	current row
LASTKY 	* = * + 1 ;.byte	$00	$00			;D7	last INKEY, CRC, buffer
INSRTO 	* = * + 1 ;.byte	$00	$00			;D8	number of INSERTs outstanding
SLLTBL 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            ...
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00	;D9	screen line link table
	      * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
SLDMY  	* = * + 1 ;.byte	$00	$00			;F1	dummy screen link
SCROWM 	* = * + 1 ;.byte	$00	$00			;F2	screen row marker
COLRPT 	* = * + 2 ;.word	$00	$00			;F3	POINTER: screen color
KEYTAB 	* = * + 2 ;.word	$00	$00			;F5	POINTER: keyboard
RIBUF  	* = * + 2 ;.word	$00	$00			;F7	POINTER: RS232 Rx
ROBUF  	* = * + 2 ;.word	$00	$00			;F9	POINTER: RS232 Tx
OSFRE0 	* = * + 1 ;.byte	$00	$00			;FB	free Z-page OS space
OSFRE1 	* = * + 1 ;.byte	$00	$00			;FC		
OSFRE2 	* = * + 1 ;.byte	$00	$00			;FD		
OSFRE3 	* = * + 1 ;.byte	$00	$00			;FE		
BASSTO 	* = * + 1 ;.byte	$00	$00			;FF	BASIC storage
...
FBUFFR 	* = * + 2 ;.word	$00	$00
            ...
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00	;0100	floating ASCII work area; tape error log; processor
	      * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
...
BUF    	* = * + 2 ;.word	$00	$00
            ...
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00	;0200		BASIC input buffer
	      * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
...
FILTBL 	* = * + 2 ;.word	$00	$00
            ...
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00		;0259	logical file table
DEVTBL 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00		;0263	devce number table
SECATB 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00		;026D	secondary address table
KBUFFR 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00		;0277	keyboard buffer
OSSTAR 	* = * + 2 ;.word	$00	$00			;0281	POINTER: start of memory for OS
OSTOP  	* = * + 2 ;.word	$00	$00			;0283	POINTER: end of BASIC memory (top of mem for OS)
STIMOT 	* = * + 1 ;.byte	$00	$00			;0285	serial bus timeout flag
CLCODE 	* = * + 1 ;.byte	$00	$00			;0286	current color code
CSRCLR 	* = * + 1 ;.byte	$00	$00			;0287	color under cursor
HIPAGE 	* = * + 1 ;.byte	$00	$00			;0288	screen memory page
KBMAXL 	* = * + 1 ;.byte	$00	$00			;0289	maximum size of keyboard buffer
KEYRPT 	* = * + 1 ;.byte	$00	$00			;028A	key repeat (80=repeat all keys)
KRPTSP 	* = * + 1 ;.byte	$00	$00			;028B	repeat speed
KRPTDL 	* = * + 1 ;.byte	$00	$00			;028C	repeat delay
SHFTFL 	* = * + 1 ;.byte	$00	$00			;028D	keyboard SHIFT/CTRL flag
LSSHFT 	* = * + 1 ;.byte	$00	$00			;028E	last keyboard shift pattern
FCEVAL 	* = * + 2 ;.word	$00	$00			;028F	POINTER: keyboard decode logic (FCEVAL)
SHMODE 	* = * + 1 ;.byte	$00	$00			;0291	shift mode (0=enabled, 80=locked)
SCRLFL 	* = * + 1 ;.byte	$00	$00			;0292	auto scroll down flag (0=on, non-zero=off)
M51CTR 	* = * + 1 ;.byte	$00	$00			;0293	RS232 control register
M51CDR 	* = * + 1 ;.byte	$00	$00			;0294	RS232 command register
M51AJB 	* = * + 2 ;.word	$00	$00			;0295	RS232 baud rate (non-standard)
RSSTAT 	* = * + 1 ;.byte	$00	$00			;0297	RS232 status register
BITNUM 	* = * + 1 ;.byte	$00	$00			;0298	number of bits to send
BAUDOF 	* = * + 2 ;.word	$00	$00			;0299	RS232 baud rate
RIDBE  	* = * + 1 ;.byte	$00	$00			;029B	RS232 receive pointer
RIDBS  	* = * + 1 ;.byte	$00	$00			;029C	RS232 input pointer
RODBS  	* = * + 1 ;.byte	$00	$00			;029D	RS232 transmit pointer
RODBE  	* = * + 1 ;.byte	$00	$00			;029E	RS232 output pointer
TAPIRQ 	* = * + 2 ;.word	$00	$00			;029F	POINTER: saved IRQ address during tape operations
PGINDR 	* = * + 1 ;.byte	$00	$00			;02A1	program indirects
;c64:	02a1	CIA2 NMI
;	02a2	CIA2 Timer A
;	02a3	CIA1 IRQ
;	02a4	CIAl Timer A
...
;Page 3 Variables
* = $0300 ;.ORG $0300
ERRVPT 	* = * + 2 ;.word	$00	$00			;0300	POINTER: ERROR message routine
MAINVP 	* = * + 2 ;.word	$00	$00			;0302	POINTER: BASIC warm start
CRNCHV 	* = * + 2 ;.word	$00	$00			;0304	POINTER: crunch BASIC tokens
LISTVP 	* = * + 2 ;.word	$00	$00			;0306	POINTER: print BASIC tokens
BYEBVP 	* = * + 2 ;.word	$00	$00			;0308	POINTER: start new BASIC code
EVALVP 	* = * + 2 ;.word	$00	$00			;030A	POINTER: get arithmetic element
R6502A 	* = * + 1 ;.byte	$00	$00			;030C	.A
R6502X 	* = * + 1 ;.byte	$00	$00			;030D	.X
R6502Y 	* = * + 1 ;.byte	$00	$00			;030E	.Y
R6502P 	* = * + 1 ;.byte	$00	$00			;030F	.P
UNKNO1 	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00			;0310	range $0310-$0313
;c64:	.byte	$4c			; User JMP vector
;	.word	USR vector
...
IRQVP  	* = * + 2 ;.word	$00	$00			;0314	IRQ		EABF
BRKVP  	* = * + 2 ;.word	$00	$00			;0316	Break		FED2
NMIVP  	* = * + 2 ;.word	$00	$00			;0318	NMI		FEAD
OPENVP 	* = * + 2 ;.word	$00	$00			;031A	OPEN		F40A
CLOSVP 	* = * + 2 ;.word	$00	$00			;031C	CLOSE		F34A
CKINVP 	* = * + 2 ;.word	$00	$00			;031E	Set Input	F2C7
CKOTVP 	* = * + 2 ;.word	$00	$00			;0320	Set Output	F309
CLCHVP 	* = * + 2 ;.word	$00	$00			;0322	Restore I/O	F3F3
CHINVP 	* = * + 2 ;.word	$00	$00			;0324	INPUT		F20E
CHOTVP 	* = * + 2 ;.word	$00	$00			;0326	OUTPUT		F27A
STOPVP 	* = * + 2 ;.word	$00	$00			;0328	STOP		F770
GTINVP 	* = * + 2 ;.word	$00	$00			;032A	GET		F1F5
CLALVP 	* = * + 2 ;.word	$00	$00			;032C	CLALL		F3EF
USERVP 	* = * + 2 ;.word	$00	$00			;032E	Warm start	FED2
LLODVP 	* = * + 2 ;.word	$00	$00			;0330	Link to Load	F549
LSAVVP 	* = * + 2 ;.word	$00	$00			;0332	Link to Save	F685
UNKNO2 	* = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            ...
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00
            * = * + 1 ;.byte	$00	$00	;0334	range $0334-$033B
CSBUF  	* = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            ...
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00	;033C	cassette buffer
	      * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
            * = * + 2 ;.word	$00	$00
...
* = $E000 ;.ORG $E000			
	...
	.byte $0F			
	.byte $DC				;From BASIC ROM @$C000 JSR $DC0F
	LDA FC1EXP			
	CMP #$88			
	BCC ELOOP2			;E00B
...
ELOOP3				
	...
	JSR NEGOP			;flip sign
	LDA #$C4 ;#$EA			;FIXUP1 ;#$C4
	LDY #$DF ;#$EA			;FIXUP1+1 ;#$DF table of some constants
...
;				
RMULC				
	.byte $98, $35, $44, $7A, $00	;11.879546

RMULC1	.byte $68, $28, $B1, $46, $00	;3.92767774e-4			
...
RANDDT					
	...
	LDA #$8A ;#$EA			;FIXUP1+2 #$8A randomize data LSB	
	LDY #$E0 ;#$EA 			;FIXUP1+3 #$E0 randomize data MSB
	JSR FMULT			;multiply FAC=FAC*const	

	LDA #$8F ;#$EA 			;FIXUP1+4 #$8F	
	LDY #$E0 ;#$EA 			;FIXUP1+5 #$E0	
...
SYS				
	...
	LDA #$E1 ;#$EA 			;FIXUP1+7 #$E1
	PHA			
	LDA #$43 ;#$EA 			;FIXUP1+6 #$43
...
VERFYT				
	...
	.byte $2C				;results in BIT $00A9 skip
...
SKPRDY				
	...
	LDA #$64 ;#$EA			;$64 FIXUP2+4 print "OK"
	LDY #$C3 ;#$EA			;$C3 FIXUP2+5
	JMP STROUT			
...
VERSK1				
	...
	STY VARTAB+1 			
	LDA #$76 ;#$EA			;$76 FIXUP2+6 print "READY"
	LDY #$C3 ;#$EA			;$C3 FIXUP2+7
	JSR STROUT			
...
;				
COS				
	LDA #$DD ;#$EA 			;FIXUP1+12;#$DD
	LDY #$E2; #$EA 			;FIXUP1+13;#$E2 PI2 table
	JSR FADD			;add to FAC
...
SIN				
	...
	LDA #$E2 ;#$EA 			;FIXUP1+14 ;#$E2
	LDY #$E2 ;#$EA 			;FIXUP1+15 ;#$E2 PI*2 table
	LDX FC2SGN			
	...
	LDA #$E7 ;#$EA 			;FIXUP1+16;#$E7
	LDY #$E2 ;#$EA 			;FIXUP1+17;#$E2
...
SINCON2				
	LDA #$EC ;#$EA 			;FIXUP1+18;#$EC ptr to poly coeff.
	LDY #$E2 ;#$EA 			;FIXUP1+19;#$E2
...
ATNSK1				
	...
	LDA #$BC ;#$EA			;$BC FIXUP2+8
	LDY #$D9 ;#$EA			;$D9 FIXUP2+9 table of flt pt constants
	JSR FDIVT			;reciprocal of FAC

ATNSK2				
	LDA #$3B ;#$EA 			;FIXUP1+22;#$3B
	LDY #$E3 ;#$EA 			;FIXUP1+23;$$E3 ATNCON - table of ATN constants
	JSR POLYX			;calc poly
	...
	LDA #$DD ;#$EA 			;FIXUP1+12;#$DD	
	LDY #$E2 ;#$EA 			;FIXUP1+13;#$E2	;const PI/2
	JSR FSUB			;pi/2-FAC	
...
INITCZ				
	...
	LDA #$48 ;#$EA 			;FIXUP1+24;#$48
	LDY #$D2 ;#$EA 			;FIXUP1+25;#$D2
	STA USRVEC			;USER vector at $D248
	STY USRVEC+1			

	LDA #$91 ;#$EA 			;FIXUP1+26;#$91
	LDY #$D3 ;#$EA 			;FIXUP1+27;#$D3
	STA ADRAY2			
	STY ADRAY2+1			;fixed-float cvt code $D391

	LDA #$AA ;#$EA			;FIXUP1+28;#$AA
	LDY #$D1 ;#$EA 			;FIXUP1+29;#$D1
	STA ADRAY1			
...
INITMS				
	...
	LDA #$36 ;#$EA 			;FIXUP1+30;#$36	WORDS text
	LDY #$E4 ;#$EA 			;FIXUP1+31;#$E4	
	...
	LDA #$29 ;#$EA 			;FIXUP1+32;#$29	FREMES text
	LDY #$E4 ;#$EA 			;FIXUP1+33;#$E4	
	JSR STROUT			;print "xx bytes free"	
	JMP SCRTCH1			;$C644 external entry into SCRTCH (NEW)

FREMES				
	.text " BYTES FREE", $0D, $00			

WORDS				
	.text $93, "**** CBM BASIC V2 ****", $0D, $00			
...
;	.word RMULC			;2 7e
;	.word RMULC1			;4 80
;	.word SYS+28			;6 82 ROM breakpoint
;	.word $C364			;8 84
;	.word $C316			;10 86
;	.word PI2				;12 88
;	.word PI22			;14 8a
...
;				
SDCLK				
	LDA VV911F			;load register
	CMP VV911F			;any change?
...
;				
FIXUP2	;$E4DA			
;	.word KNRLSV			;0 e4da FD6D
;	.word KDECD1			;2 dc
;	.word $c364			;4 de OK
;	.word $c376			;6 e0 ready
;	.word $d9bc			;8 e2 FONE
;	.word $FFFF			;10 e4
;	.word $FFFF			;12 e6
;	.word $FFFF			;14 e8
...
CINT1				
	...
	ASL A			
	ORA #%10000000			;$80
	STA VV9005			;set chargen ROM to $8000
...
CINT1A				
	...
	LDA #$DC ;#$EA 			;FIXUP1+34;#$DC
	STA FCEVAL			
	LDA #$EB ;#$EA 			;FIXUP1+35;#$EB
...
XLATB1	
	.byte $EF, $A1, $DF, $A6, $E1, $B1, $E2, $B2
	.byte $E3, $B3, $E4, $B4, $E5, $B5, $E6, $B6
	.byte $E7, $B7, $E8, $B8, $E9, $B9, $FA, $BA
	.byte $FB, $BB, $FC, $BC, $EC, $BD, $FE, $BE
	.byte $84, $BF, $F7, $C0, $F8, $DB, $F9, $DD
	.byte $EA, $DE, $5E, $E0, $5B, $E1, $5D, $E2
	.byte $40, $B0, $61, $B1, $78, $DB, $79, $DD
	.byte $66, $B6, $77, $C0, $70, $F0, $71, $F1
	.byte $72, $F2, $73, $F3, $74, $F4, $75, $F5
	.byte $76, $F6, $7D, $FD
...
IRQVEC4				
	...
	STA VV911C			;set motor status

IRQVEC5				
	JSR ISCNKY			;Eb1E scan keyboard
	BIT VV9124			;9124 D2T1 latch lsb 
	PLA			
	TAY			
	PLA			
	TAX			
...
ISCNKY				
	...
	STA VV9120			
	LDY #$00			
	LDA #$5E ;#$EA 			;FIXUP2+2;#$5E
	STA KEYTAB			
	LDA #$EC ;#$EA 			;FIXUP2+3;#$EC
	STA KEYTAB+1			
...
;				
KDECOD				
	.word KDECD1			;$EC5E Unshifted
	.word KDECD2			;$EC9F Shifted
	.word KDECD3			;$ECE0 Commodore
	.word KDECD5			;$EDA3 Control
	.word KDECD1			;$EC5E Unshifted
	.word KDECD2			;$EC9F Shifted
	.word KDECD4			;$ED69 Shfited
	.word KDECD5			;$EDA3 Control
	.word GRTXTF			;$ED21 Graphics/text control
	.word KDECD4			;$ED69 Shifted
	.word KDECD4			;$ED69 Shifted
	.word KDECD5			;$EDA3 Control
;				
;Unshifted				
...
KDECD1     ;pa0  pa1  pa2  pa3  pa4  pa5  pa6  pa7
	.byte $31, $33, $35, $37, $39, $2B, $5C, $14	;col 0
	.byte $5F, $57, $52, $59, $49, $50, $2A, $0D	;col 1			
	.byte $04, $41, $44, $47, $4A, $4C, $3B, $1D	;col 2			
	.byte $03, $01, $58, $56, $4E, $2C, $2F, $11	;col 3		
	.byte $20, $5A, $43, $42, $4D, $2E, $01, $85 	;col 4		
	.byte $02, $53, $46, $48, $4B, $3A, $3D, $86	;col 5		
	.byte $51, $45, $54, $55, $4F, $40, $5E, $87	;col 6		
	.byte $32, $34, $36, $38, $30, $2D, $13, $88	;col 7		
	.byte $FF						; EOT
;				
;shifted	
;	
KDECD2	
	.byte $21, $23, $25, $27, $29
	.byte $DB, $A9, $94, $5F, $D7, $D2, $D9, $C9
	.byte $D0, $C0, $8D, $04, $C1, $C4, $C7, $CA
	.byte $CC, $5D, $9D, $83, $01, $D8, $D6, $CE
	.byte $3C, $3F, $91, $A0, $DA, $C3, $C2, $CD
	.byte $3E, $01, $89, $02, $D3, $C6, $C8, $CB
	.byte $5B, $3D, $8A, $D1, $C5, $D4, $D5, $CF
	.byte $BA, $DE, $8B, $22, $24, $26, $28, $30
	.byte $DD, $93, $8C, $FF 
;	
;Commodore	
;	
KDECD3	
	.byte $21, $23, $25, $27			
	.byte $29, $A6, $A8, $94, $5F, $B3, $B2, $B7			
	.byte $A2, $AF, $DF, $8D, $04, $B0, $AC, $A5			
	.byte $B5, $B6, $5D, $9D, $83, $01, $BD, $BE			
	.byte $AA, $3C, $3F, $91, $A0, $AD, $BC, $BF			
	.byte $A7, $3E, $01, $89, $02, $AE, $BB, $B4			
	.byte $A1, $5B, $3D, $8A, $AB, $B1, $A3, $B8			
	.byte $B9, $A4, $DE, $8B, $22, $24, $26, $28			
	.byte $30, $DC, $93, $8C, $FF			
;				
...
KDECD4	
	.byte $FF, $FF, $FF
	.byte $FF, $FF, $FF, $FF, $FF, $FF, $04, $FF
	.byte $FF, $FF, $FF, $FF, $E2, $9D, $83, $01
	.byte $FF, $FF, $FF, $FF, $FF, $91, $A0, $FF
	.byte $FF, $FF, $FF, $EE, $01, $89, $02, $FF
	.byte $FF, $FF, $FF, $E1, $FD, $8A, $FF, $FF
	.byte $FF, $FF, $FF, $B0, $E0, $8B, $F2, $F4
	.byte $F6, $FF, $F0, $ED, $93, $8C, $FF 
;	
;Keyboard decoding table - control	
;	
KDECD5	
	.byte $90
	.byte $1C, $9C, $1F, $12, $FF, $FF, $FF, $06
	.byte $FF, $12, $FF, $FF, $FF, $FF, $FF, $FF
	.byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
	.byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
	.byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
	.byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
	.byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $05
...
;	.byte $00, $00, $00, $00, $00, $00, $00, $1B
	...
	.byte $0C ;$05	;bit7 interlace, 6-0 HCenter
	.byte $26 ;$19	;VCenter
	.byte $16	;bit7=video address, 6-0 #rcols
	.byte $2E	;bit6-1=#rows, bit0=8x8 or 16x8 chars
	.byte $00	;current TV raster beam line
	.byte $C0	;bit0-3 start of char memory
		...
		;1110        1800  6144
		;1111        1C00  7168
	.byte $00	;Hpos of light pen
	.byte $00	;Vpos of light pen

	.byte $00 ;Digitized value of paddle X /EDEC
	.byte $00 ;Digitized value of paddle Y
	.byte $00 ;Frequency for oscillator 1 (low)
	.byte $00 ;Frequency for oscillator 2 (medium)
	.byte $00 ;Frequency for oscillator 3 (high)
	.byte $00 ;Frequency of noise source
	.byte $00 ; bit0-3 sets volume of all sound
		; bit4-7 are auxiliary color information
	.byte $1B	;Screen and border color register
...
PRSBEX				
	...
	BNE SBE02			;$F0A8
	BEQ SBE80			;$F0A5
JJF0B9 JMP IOERMS9			;$F796 "ILLEGAL DEVICE" error
...
;					
KIOMSG					
	.text $0D, "I/O ERROR ", $A3			;0$00

	.text $0D, "SEARCHING", $A0, "FOR", $A0		;0Ch

	.text $0D, "PRESS PLAY ON TAP", $C5		;1Bh	

	.text "PRESS RECORD & PLAY ON TAP", $C5		;2Eh	

	.text $0D, "LOADIN", $C7				;49h

	.text $0D, "SAVING", $A0				;51h

	.text $0D, "VERIFYIN", $C7			;59h

	.text $0D, "FOUND", $A0				;63h
...
TAPESV				
	...
	JMP JJF0B9 ;IOERMS9			;IOERMS9 "ILLEGAL DEVICE NUMBER" error
...
TPSTAT				
	LDA #%01000000			;$40
	BIT VV911F			;switch sense
	BNE TPSTEX			;$F8B5 not pressed, exit
	BIT VV911F			;button pressed. Setup for another
...
TPCODE1				
	...
	STA VV911C			;switch on tape drive
	STA CAS1			;flag as on
...
IRESTR				
	LDX #$6D ;#$EA 			;FIXUP2;#$6D
	LDY #$FD ;#$EA 			;FIXUP2+1;#$FD $FD6D KERNEL vecs
	CLC			
;				
...
;FD7D 				
;FD85 				
	.word IRQVEC, WARMST, LNKNMI, IOPEN			
	.word ICLOSE, ICHKIN, ICHKOT, ICLRCH			
	.word ICHRIN, ICHROT, ISTOP,  IGETIN			
	.word ICLALL, WARMST, LNKLOD, LNKSAV			
...
;				
TAPEVC				
;	.word $FCA8, $FC0B, $EABF, $F98E			
	.word WRLDR2, TWRD7, IRQVEC, RDTPBT			
...
LNKNMI				
	...
	TYA			
	PHA			
	LDA VV911D			;check VIA interrupt flag
	BPL WARMEOI			;no flag, then issue EOI

	AND VV911E			; see if interrupt is allowed
...
LNKNMI1					;continue NMI - no expansion ROM
	BIT VV9111			;test ATN IN (7)/cass sw(6)
...
WARM1					; RS232 NMI routines.
	...
	STA VV911C			;CB2 manual L/H; CB1 neg trans for
					; IRQ; CA2 manual H; CA1 neg trans
					; for IRQ; CB2=TX, CA2=cass motor
					; control
	LDA VV9114			;get VIA1/T1 count byte low
	PLA				;restore IER bitmap
	STA VV911E			; and save it
...
;	.byte $40, $1A			;75 baud
;	.byte $C6, $11			;110 baud
;	.byte $74, $0E			;134.5 baud
;	.byte $EE, $0C 			;150 baud
;	.byte $45, $06			;300 baud
;	.byte $F1, $02			;600 baud
;	.byte $46, $01			;1200 baud
;	.byte $B8, $00			;1800 baud
;	.byte $71, $00			;2400 baud
;	.byte $2A, $00			;4800 baud (??)
...
;					
					...
					;$ff85	
	.word $FFFF			;sentinal (KERNAL version??)
	.byte $FF				;unused JMP
	...
	.byte $FF				;unused JMP
	.word $FFFF			;unused vector
	.byte $FF				;sentinal (kernal version number??)
