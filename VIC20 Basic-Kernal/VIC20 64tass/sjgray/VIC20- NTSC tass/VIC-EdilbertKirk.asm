...
; ********************
   ...
   .byte $79,<Basic_PLUS-1     ,>Basic_PLUS-1     ; $AA
   .byte $79,<Basic_MINUS-1    ,>Basic_MINUS-1    ; $AB
   .byte $7B,<Basic_MULTIPLY-1 ,>Basic_MULTIPLY-1 ; $AC
   .byte $7B,<Basic_DIVIDE-1   ,>Basic_DIVIDE-1   ; $AD
   .byte $7F,<Basic_POWER-1    ,>Basic_POWER-1    ; $AE
   .byte $50,<Basic_AND-1      ,>Basic_AND-1      ; $AF
   .byte $46,<Basic_OR-1       ,>Basic_OR-1       ; $B0
   .byte $7D,<Basic_GREATER-1  ,>Basic_GREATER-1  ; $B1
   .byte $5A,<Basic_EQUAL-1    ,>Basic_EQUAL-1    ; $B2
   .byte $64,<Basic_LESS-1     ,>Basic_LESS-1     ; $B3
...
; the functions
   ...
   .SHIFT   "RIGHT$" ;^ ; RIGHT$
   .SHIFT   "MID$" ;^   ; MID$
   .SHIFT   "GO" ;^     ; GO so that GO TO, as well as GOTO, will work
   .BYTE   $00       ; end marker

; error messages

ERR_01 .SHIFT   "TOO MANY FILES" ;^
ERR_02 .SHIFT   "FILE OPEN" ;^
ERR_03 .SHIFT   "FILE NOT OPEN" ;^
ERR_04 .SHIFT   "FILE NOT FOUND" ;^
ERR_05 .SHIFT   "DEVICE NOT PRESENT" ;^
ERR_06 .SHIFT   "NOT INPUT FILE" ;^
ERR_07 .SHIFT   "NOT OUTPUT FILE" ;^
ERR_08 .SHIFT   "MISSING FILE NAME" ;^
ERR_09 .SHIFT   "ILLEGAL DEVICE NUMBER" ;^
ERR_0A .SHIFT   "NEXT WITHOUT FOR" ;^
ERR_0B .SHIFT   "SYNTAX" ;^
ERR_0C .SHIFT   "RETURN WITHOUT GOSUB" ;^
ERR_0D .SHIFT   "OUT OF DATA" ;^
ERR_0E .SHIFT   "ILLEGAL QUANTITY" ;^
ERR_0F .SHIFT   "OVERFLOW" ;^
ERR_10 .SHIFT   "OUT OF MEMORY" ;^
ERR_11 .SHIFT   "UNDEF'D STATEMENT" ;^
ERR_12 .SHIFT   "BAD SUBSCRIPT" ;^
ERR_13 .SHIFT   "REDIM'D ARRAY" ;^
ERR_14 .SHIFT   "DIVISION BY ZERO" ;^
ERR_15 .SHIFT   "ILLEGAL DIRECT" ;^
ERR_16 .SHIFT   "TYPE MISMATCH" ;^
ERR_17 .SHIFT   "STRING TOO LONG" ;^
ERR_18 .SHIFT   "FILE DATA" ;^
ERR_19 .SHIFT   "FORMULA TOO COMPLEX" ;^
ERR_1A .SHIFT   "CAN'T CONTINUE" ;^
ERR_1B .SHIFT   "UNDEF'D FUNCTION" ;^
ERR_1C .SHIFT   "VERIFY" ;^
ERR_1D .SHIFT   "LOAD" ;^
...
Msg_OK    .TEXT   "\rOK\r",0
.if C64
Msg_Err   .TEXT   "  ERROR",0
.endif
.if VIC
Msg_Err   .TEXT   "\r ERROR",0
.endif
Msg_IN    .TEXT   " IN ",0
Msg_Ready .TEXT   "\r\nREADY.\r\n",0
Msg_CrLf  .TEXT   "\r\n"
Msg_Break .TEXT   "BREAK",0
...
; ===========
   ...
   #Print_Msg Msg_Ready ;Print_Msg(Msg_Ready)
...
BaIn_50
   #Print_Msg Msg_Redo_From_Start ;Print_Msg(Msg_Redo_From_Start)
...
BaGE_10
   ...
   BNE BaIN_101       ; if not default channel go do channel close and return
   RTS
...
BaIN_201
   ...
   LDA IOPMPT        ; get current I/O channel
   BEQ BaIN_301       ; branch if default I/O channel
   JSR READST        ; read I/O status word
   AND #$02          ; mask no DSR/timeout
   BEQ BaIN_301       ; branch if not error
...
BaIN_301
   ...
   BNE BaIN_501
   LDA IOPMPT        ; get current I/O channel
   BNE BaIN_201       ; if not default channel go get BASIC input
   JSR Next_Statement
...
; ****************
   ...
   LDA IOPMPT        ; get current I/O channel
   BNE BaIN_401       ; skip "?" prompt if not default channel
   JSR Print_Question_Mark
   JSR Cursor_Right_Or_Space
BaIN_401
   JMP Read_String
...
Msg_Extra_Ignored   .TEXT "?EXTRA IGNORED\r",0
Msg_Redo_From_Start .TEXT "?REDO FROM START\r",0
...
Float_PI .byte $82,$49,$0F,$DA,$A1 ;.real 3.141592653
...
; =============
   ...
   JSR CHRGET
   CPX #$8F ;#((TK_CHRS - $80) * 2) + 1 ; chr$ index + 1
...
FuCa_20
.if C64
   LDA $9FEA,y ;Basic_Function_Table-2*(TK_SGN-$80),Y    ; .. -$68
.endif
.if VIC
   LDA $BFEA,y ;Basic_Function_Table-2*(TK_SGN-$80),Y    ; .. -$68
.endif
   STA FUNJMP
.if C64
   LDA $9FEB,y ;Basic_Function_Table-2*(TK_SGN-$80)+1,Y  ; .. -$67
.endif
.if VIC
   LDA $BFEB,y ;Basic_Function_Table-2*(TK_SGN-$80)+1,Y  ; .. -$67
.endif
   STA FUNJMP+1
   JSR JUMPER
   JMP Is_Numeric
...
Float_M32768 .byte $90,$80,$00,$00,$00 ;.real -32768
...
REAL_1 .byte $81,$00,$00,$00,$00 ;.real 1

VLOG_A
   .byte   $03            ; series counter
   .byte $7F,$5E,$56,$CB,$79 ;.real   0.4342559419
   .byte $80,$13,$9B,$0B,$64 ;.real   0.5765845413
   .byte $80,$76,$38,$93,$16 ;.real   0.9618007592
   .byte $82,$38,$AA,$3B,$20 ;.real   2.8853900731

HALF_SQRT_2 .byte $80,$35,$04,$F3,$34 ;.real   0.7071067812  ; 0.5 * sqrt(2.0)
SQRT_2      .byte $81,$35,$04,$F3,$34 ;.real   1.4142135624  ; sqrt(2.0)
MINUS_0_5   .byte $80,$80,$00,$00,$00 ;.real  -0.5
LN_2        .byte $80,$31,$72,$17,$F8 ;.real   0.6931471807  ; ln(2.0)
...
Float_10 .byte $84,$20,$00,$00,$00 ;.real 10
...
MAXREAL_A .byte $9B,$3E,$BC,$1F,$FD ;.real   99999999.90625
MAXREAL_B .byte $9E,$6E,$6B,$27,$FD ;.real  999999999.25
MAXREAL_C .byte $9E,$6E,$6B,$28,$00 ;.real 1000000000
...
; ========================
   ...
   .byte $FA,$0A,$1F,$00 ;.quad -100000000
   .byte $00,$98,$96,$80 ;.quad  +10000000
   .byte $FF,$F0,$BD,$C0 ;.quad   -1000000
   .byte $00,$01,$86,$A0 ;.quad    +100000
   .byte $FF,$FF,$D8,$F0 ;.quad     -10000
   .byte $00,$00,$03,$E8 ;.quad      +1000
   .byte $FF,$FF,$FF,$9C ;.quad       -100
   .byte $00,$00,$00,$0A ;.quad        +10
   .byte $FF,$FF,$FF,$FF ;.quad         -1

; ======================
  Jiffy_Conversion_Table
; ======================

   .byte $FF,$DF,$0A,$80 ;.quad -2160000 ; 10s hours
   .byte $00,$03,$4B,$C0 ;.quad  +216000 ;     hours
   .byte $FF,$FF,$73,$60 ;.quad   -36000 ; 10s mins
   .byte $00,$00,$0E,$10 ;.quad    +3600 ;     mins
   .byte $FF,$FF,$FD,$A8 ;.quad     -600 ; 10s secs
   .byte $00,$00,$00,$3C ;.quad      +60 ;     secs
...
REV_LOG_2 .byte $81,$38,$AA,$3B,$29 ;.real 1.4426950408

VAR_EXP
   .byte   7         ; series count

   .byte $71,$34,$58,$3E,$56 ;.real  2.1498763705E-5
   .byte $74,$16,$7E,$B3,$1B ;.real  1.4352314041E-4
   .byte $77,$2F,$EE,$E3,$85 ;.real  1.3422634825E-3
   .byte $7A,$1D,$84,$1C,$2A ;.real  9.6140170140E-3
   .byte $7C,$63,$59,$58,$0A ;.real  5.5505126870E-2
   .byte $7E,$75,$FD,$E7,$C6 ;.real  2.4022638465E-1
   .byte $80,$31,$72,$18,$10 ;.real  6.9314718640E-1
   .byte $81,$00,$00,$00,$00 ;.real  1.0
...
RND_VA .byte $98,$35,$44,$7A,$00 ;.real 11879546 
RND_VB .byte $68,$28,$B1,$46,$00 ;.real 3.927677739E-8
...
PI_Half    .byte $81,$49,$0F,$DA,$A2 ;.real 1.5707963271
Two_PI     .byte $83,$49,$0F,$DA,$A2 ;.real 6.283185307
Float_0_25 .byte $7F,$00,$00,$00,$00 ;.real 0.25

VAR_SIN
   .byte   $05       ; series counter
   .byte $84,$E6,$1A,$2D,$1B ;.real -14.381390673
   .byte $86,$28,$07,$FB,$F8 ;.real  42.00779713
   .byte $87,$99,$68,$89,$01 ;.real -76.70417028
   .byte $87,$23,$35,$DF,$E1 ;.real  81.60522370
   .byte $86,$A5,$5D,$E7,$28 ;.real -41.34170211
   .byte $83,$49,$0F,$DA,$A2 ;.real   6.283185308
...
VAR_ATN
   ...
   .byte $76,$B3,$83,$BD,$D3 ;.real -6.8479391200E-4
   .byte $79,$1E,$F4,$A6,$F5 ;.real  4.8509421570E-3
   .byte $7B,$83,$FC,$B0,$10 ;.real -1.6111701850E-2
   .byte $7C,$0C,$1F,$67,$CA ;.real  3.4209638050E-2
   .byte $7C,$DE,$53,$CB,$C1 ;.real -5.4279132770E-2
   .byte $7D,$14,$64,$70,$4C ;.real  7.2457196550E-2
   .byte $7D,$B7,$EA,$51,$7A ;.real -8.9802395400E-2
   .byte $7D,$63,$30,$88,$7E ;.real  1.1093241345E-1
   .byte $7E,$92,$44,$99,$3A ;.real -0.1428398077
   .byte $7E,$4C,$CC,$91,$C7 ;.real  0.1999991205
   .byte $7F,$AA,$AA,$AA,$13 ;.real -0.3333333157
   .byte $81,$00,$00,$00,$00 ;.real  1.0
...
; *********************
   ...
   #LDAY TXTTAB      ; get start of memory
   JSR Check_Mem_Avail
   #Print_Msg Start_Message ;Print_Msg(Start_Message)
   ...
   JSR Print_Integer_XA
   #Print_Msg Bytes_Free_Message ;Print_Msg(Bytes_Free_Message)
   JMP Perform_NEW
...
Bytes_Free_Message
   .TEXT " BASIC BYTES FREE\r",0

Start_Message
   .BYTE $93
.if JIFFY
   .TEXT "\r       JIFFYDOS V6.01 (C)1989 CMD  \r"
   .TEXT "\r C-64 BASIC V2   ",0
.else
   .TEXT "\r    **** COMMODORE 64 BASIC V2 ****\r"
   .TEXT "\r 64K RAM SYSTEM  ",0
.endif
   .BYTE $81
...
ClPa_10
   ...
   .FILL 38 ,$ff     ; spare bytes, not referenced
.endif
.endif
...
.else
   .byte   $0C ;$05       ; horizontal offset [NTSC]
   .byte   $26 ;$19       ; vertical origin [NTSC]
.endif
...
Msg_Start     .SHIFT "\rI/O ERROR #" ;^
Msg_Searching .SHIFT "\rSEARCHING "  ;^
Msg_FOR       .SHIFT "FOR "          ;^
...
.else
Msg_Play      .SHIFT "\rPRESS PLAY ON TAPE"        ;^
Msg_Record    .SHIFT "PRESS RECORD & PLAY ON TAPE" ;^
.endif
Msg_Loading   .SHIFT "\rLOADING"     ;^
Msg_Saving    .SHIFT "\rSAVING "     ;^
Msg_Verifying .SHIFT "\rVERIFYING"   ;^
Msg_Found     .SHIFT "\rFOUND "      ;^
Msg_okIO      .SHIFT "\rOK\r"        ;^
...
Jiffy_Transfer_01
   .TEXT "M-W",$00,$06,$1c ; memory write $0600 - $061b
...
Jiffy_Disk_Code_01   ; $1c bytes drive code
   ...
   .TEXT "M-E",$00,$06            ; memory execute at $0600
   .TEXT "M-W",$6a,$00,$01        ; memory write   at $006a
   .TEXT "M-W",$69,$00,$01        ; memory write   at $0069
...
Jiffy_F1  .TEXT "@$:*\r",0           ; directory
Jiffy_F3  .TEXT "/",0                ; load
Jiffy_F5  .TEXT "^",0                ; save
Jiffy_F7  .TEXT "%",0                ; load ML
Jiffy_F2  .TEXT "@D",0
Jiffy_F4  .TEXT "@T",0
Jiffy_F6  .TEXT "_",0
Jiffy_F8  .TEXT "@  ",QUOTE,"S:",0
.if VIC
   .byte $24
.endif
.else
...
; ******************
   ...
   .TEXT "@"         ;  0 : disk status and command
   .TEXT "_"         ;  1 : <- save file
   .TEXT "*"         ;  2 : *  copy file
   .byte $ac         ;  3 :    copy file
   .byte QUOTE       ;  4 : nothing
   .byte $12         ;  5 : nothing
   .TEXT "/"         ;  6 : load Basic program
   .byte $ad         ;  7
   .TEXT "%"         ;  8
   .TEXT "^"         ;  9
   .byte $ae         ; 10
   ...
   .TEXT "D"         ; 13 : display basic program
   .TEXT "L"
   .TEXT "T"
   .TEXT "#"
   .TEXT "B"
...
.if C64
ROM_SIG .TEXT $C3,$C2,$CD,"80" ; CBM80
.endif
.if VIC
ROM_SIG .TEXT "A0",$C3,$C2,$CD ; A0CBM
.endif
...
.else
   LDA #$26 ;#$89          ; set timer constant low byte [NTSC]
.endif
   STA VIA2_T1CL     ; set VIA 2 T1C_l
.if PAL
   LDA #$48          ; set timer constant high byte [PAL]
.else
   LDA #$48 ;#$42          ; set timer constant high byte [NTSC]
.endif
   STA VIA2_T1CH     ; set VIA 2 T1C_h
   RTS
.endif
...
; --------------------------------
   .word	$2AE6 ;.word   $2792     ;   50   baud
   .word	$1C78 ;.word   $1A40     ;   75   baud
   .word	$1349 ;.word   $11C6     ;  110   baud
   .word	$0FB1 ;.word   $0E74     ;  134.5 baud
   .word	$0E0A ;.word   $0CEE     ;  150   baud
   .word	$06D3 ;.word   $0645     ;  300   baud
   .word	$0338 ;.word   $02F1     ;  600   baud
   .word	$016A ;.word   $0146     ; 1200   baud
   .word	$00D0 ;.word   $00B8     ; 1800   baud
   .word	$0083 ;.word   $0071     ; 2400   baud
   .word	$0036 ;.word   $002A     ; 3600   baud
.endif
.endif
